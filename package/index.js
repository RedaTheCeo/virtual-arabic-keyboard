...
function ArabicKeyBoardMain() {
    var self = this;
    this.VKI_version = "v 1.0";
        ...
        if (elem) {
            for (var y = 0, keyid = "", ex; ex = elem[y++];) {
                if ((ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password") && ex.className.indexOf("keyboardInput") > -1) {
                    ...
                    keybut.src = "https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/null/external-keyboard-game-design-flaticons-lineal-color-flat-icons.png";
                    keybut.alt = "Keyboard interface";
                    keybut.style.height = "24px"
                    keybut.style.width = "27px"
    ...
    if (layouts > 1) {
        ...
        kblist.style.border="2px solid #eee"
        kblist.style.borderRadius="4px"
        kblist.style.backgroundColor="#DBCFB2"
...
if (window.addEventListener) {
    window.addEventListener('load', ArabicKeyBoardMain, false);
} else if (window.attachEvent)
    window.attachEvent('onload', ArabicKeyBoardMain);
...
module.exports = VKI_disableSelection